...
class LexIndicPDF(FPDF):
    ...
    def header(self):
        ...
        self.set_y(3)
        self.cell(0, 6, "LEX-INDIC  |  BNS Case Brief  |  CONFIDENTIAL", align="C",
...
def build_cover_page(pdf: LexIndicPDF, sections: dict):
    ...
    pdf.cell(0, 16, "LEX-INDIC", align="C", new_x=XPos.LMARGIN, new_y=YPos.NEXT)

    pdf.set_font("Helvetica", "", 11)
    pdf.set_text_color(200, 220, 255)
    pdf.cell(0, 7, "BNS TRANSITION ENGINE", align="C",
             new_x=XPos.LMARGIN, new_y=YPos.NEXT)
    pdf.set_font("Helvetica", "I", 9)
    pdf.cell(0, 6, "AI-Powered Junior Associate for Indian Law Firms",
             align="C", new_x=XPos.LMARGIN, new_y=YPos.NEXT)
